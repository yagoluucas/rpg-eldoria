...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function historiaMalvagor() {
        ...
        geral.dialogo[2].textContent = ''
        geral.revelarDialogo(4000, geral.dialogo[2], 'Assolou nossas terras, desafiando a harmonia que reinava entre elfos, anões e fadas. Com suas artimanhas, desencadeou conflitos e semeou discórdia, tornando-se a personificação da sombra que paira sobre Eldoria')
        setTimeout(() => {
            geral.btnAvancar.removeEventListener('click', historiaMalvagor)
            geral.revelarDialogo(0, geral.btnAvancar, 'Continuar')
    ...
    function fimHistoriaMalvagor() {
        ...
        geral.dialogo[2].textContent = ''
        geral.btnAvancar.classList.add('none')
        geral.revelarDialogo(0, geral.dialogo[1], 'Agora, viajante corajoso, tua missão é clara. Explore as terras de Eldoria, converse com as criaturas mágicas, busque conhecimento nas antigas bibliotecas elficas, forje alianças com anões nas profundezas das montanhas e ganhe a confiança das fadas nos bosques encantados. Reúne artefatos perdidos, aprimora tuas habilidades mágicas e prepara-te para confrontar Malvagor.')
        geral.revelarDialogo(5000, geral.dialogo[2], 'Cada escolha que fizeres moldará tua jornada, influenciando o destino de Eldoria. A treva aguarda, mas a luz repousa em teu coração. O reino depende de tua bravura. Parta agora, e escreva sua lenda neste mundo de magia e mistério.')
        geral.revelarDialogo(10000, geral.btnAvancar, 'Iniciar aventura...')
